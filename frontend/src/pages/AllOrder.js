                          ...
                          <div className='flex flex-col lg:flex-row justify-between'>
                              ...
                              <div className='flex flex-col gap-4 p-2 min-w-[300px]'>
                                <div>
                                    ...
                                    <p className=' ml-1'>Payment method : {item.paymentDetails?.payment_method_type?.[0] || 'N/A'}</p>
                                    <p className=' ml-1'>Payment Status : {item.paymentDetails?.payment_status || 'N/A'}</p>
                                </div>
                                <div>
